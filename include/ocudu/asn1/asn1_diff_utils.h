...
// =============================================================================
// FILE: include/ocudu/asn1/asn1_diff_utils.h  (251 lines)
//
                              ...
                              const GetId&      id_func)
{
  ...
  ocudu_sanity_check(std::is_sorted(prev_list.begin(), prev_list.end(), id_cmp_op), "Expected sorted list");
  ocudu_sanity_check(std::is_sorted(add_diff_list.begin(), add_diff_list.end(), id_cmp_op), "Expected sorted list");
  ocudu_sanity_check(std::is_sorted(rm_diff_list.begin(), rm_diff_list.end()), "Expected sorted list");
                                                                           ...
                                                                           const GetId&      id_func)
{
  auto id_cmp_op = make_id_comparator(id_func);
  ocudu_sanity_check(std::is_sorted(prev_list.begin(), prev_list.end(), id_cmp_op), "Expected sorted list");
  ocudu_sanity_check(std::is_sorted(next_list.begin(), next_list.end(), id_cmp_op), "Expected sorted list");
