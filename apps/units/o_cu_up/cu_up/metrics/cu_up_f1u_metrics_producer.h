...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/metrics/cu_up_f1u_metrics_producer.h  (29 lines)
//
// Purpose (plain English):
//   Producer that receives F1-U metrics from the CU-UP core and pushes them into the fan-out pipeline.
// =============================================================================
