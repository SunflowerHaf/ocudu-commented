...
// =============================================================================
// FILE: helpers/metrics/json_generators/du_high/scheduler.cpp  (157 lines)
//
// Serialises per-UE scheduler metrics to JSON: DL/UL MCS, bitrate, HARQ, CQI, RI, BSR, timing advance.
// =============================================================================
