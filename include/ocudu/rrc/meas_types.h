...
// =============================================================================
// FILE: include/ocudu/rrc/meas_types.h  (594 lines)
//
...
// Cell meas config formatter
template <>
struct formatter<ocudu::ocucp::rrc_meas_obj_nr> {
  ...
  auto format(const ocudu::ocucp::rrc_meas_obj_nr& meas_object, FormatContext& ctx) const
  {
