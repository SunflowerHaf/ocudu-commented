...
// =============================================================================
// FILE: services/metrics/periodic_metrics_report_controller.h
//
// Purpose (plain English):
//   A timer-driven controller that fires once per reporting interval (default 1 second) to trigger all registered producers to flush their accumulated metrics. Uses the application timer manager; the timer is always re-armed unless stop() has been called.
// =============================================================================
