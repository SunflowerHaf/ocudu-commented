...
// =============================================================================
// FILE: helpers/metrics/json_generators/du_high/rlc.cpp  (76 lines)
//
// Serialises RLC metrics to JSON: AM/UM TX/RX byte counts, retransmissions, discards, per-RB breakdown.
// =============================================================================
