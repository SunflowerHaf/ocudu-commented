...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/cu_cp_cmdline_commands.h  (323 lines)
//
// Purpose (plain English):
//   Console commands for the CU-CP: operator-accessible commands for UE release, handover initiation, and cell reselection; each implements cmdline_command.
// =============================================================================
