...
// =============================================================================
// FILE: include/ocudu/pdcp/pdcp_tx_metrics.h  (122 lines)
//
...
// PDCP TX metrics formatter
template <>
struct formatter<ocudu::pdcp_tx_metrics_container> {
  ...
  auto format(const ocudu::pdcp_tx_metrics_container& m, FormatContext& ctx) const
  {
