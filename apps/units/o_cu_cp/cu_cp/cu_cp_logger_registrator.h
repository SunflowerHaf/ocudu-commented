...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/cu_cp_logger_registrator.h  (54 lines)
//
// Purpose (plain English):
//   Registers all CU-CP log channels (CU-CP, CU-UEMNG, PDCP, RRC, CU-CP-E1, CU-CP-F1, NGAP, XNAP, NRPPA, SEC) with the central logger service.
// =============================================================================
