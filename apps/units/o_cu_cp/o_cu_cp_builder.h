...
// =============================================================================
// FILE: apps/units/o_cu_cp/o_cu_cp_builder.h  (59 lines)
//
// Purpose (plain English):
//   Declares build_o_cu_cp() factory plus o_cu_cp_unit_dependencies (executor mapper, timer manager, NGAP PCAP, io_broker, E2 GW, metrics notifier, Xn gateways) and o_cu_cp_unit output (live CU-CP, commands, metrics).
// =============================================================================
