...
// =============================================================================
// FILE: helpers/metrics/json_generators/cu_cp/cu_cp_json_helper.cpp  (154 lines)
//
// Serialises CU-CP metrics to JSON: UE attach/detach counts, handover stats, connection duration histograms.
// =============================================================================
