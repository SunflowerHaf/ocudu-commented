...
// =============================================================================
// FILE: services/application_message_banners.h
//
// Purpose (plain English):
//   RAII helper that prints '==== gNB started ===' to stdout and the log on construction, and 'Stopping...' on destruction. Also announces the build commit hash. Ensures startup/shutdown is always logged even if the user hasn't set up a log file yet.
// =============================================================================
