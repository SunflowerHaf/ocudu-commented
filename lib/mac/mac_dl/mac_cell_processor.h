...
// =============================================================================
// FILE: lib/mac/mac_dl/mac_cell_processor.h  (132 lines)
//
// LIBRARY: lib/mac
...
private:
  void handle_slot_indication_impl(slot_point_extended sl_tx, metric_clock::time_point enqueue_slot_tp) noexcept;
