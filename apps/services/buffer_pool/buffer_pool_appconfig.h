...
// =============================================================================
// FILE: services/buffer_pool/buffer_pool_appconfig.h
//
// Purpose (plain English):
//   Configuration for the shared byte-buffer segment pool: number of segments and segment size. The pool is the pre-allocated memory from which all protocol PDU buffers are drawn; tuning these values affects peak memory use and the maximum simultaneous in-flight packets.
// =============================================================================
