...
// =============================================================================
// FILE: include/ocudu/support/format/custom_formattable.h  (151 lines)
//
...
template <typename FormatFunc>
struct formatter<ocudu::detail::custom_formattable<FormatFunc>> : public basic_parser {
public:
  template <typename FormatContext>
  auto format(const ocudu::detail::custom_formattable<FormatFunc>& f, FormatContext& ctx) const
  {
    return f.format(ctx);
  }
};
...
template <typename T>
struct formatter<ocudu::detail::optional_prefix_formatter<T>> : public basic_parser {
  template <typename FormatContext>
  auto format(const ocudu::detail::optional_prefix_formatter<T>& f, FormatContext& ctx) const
  {
...
template <typename T>
struct formatter<ocudu::detail::value_or_else<T>> {
  ...
  template <typename FormatContext>
  auto format(const ocudu::detail::value_or_else<T>& obj, FormatContext& ctx) const
  {
