...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/tracing/tracer_appconfig_cli11_schema.cpp
// Registers the [trace] YAML section for executor tracing. All three options
// have sensible defaults and are captured so the print-effective-config works.
// =============================================================================
