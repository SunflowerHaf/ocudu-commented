...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/metrics/cu_up_f1u_metrics.h  (56 lines)
//
// Purpose (plain English):
//   Metrics framework wrappers for CU-UP F1-U user-plane metrics: TX/RX bytes and packets, latency. Defines properties, snapshot class, and dispatch callback.
// =============================================================================
