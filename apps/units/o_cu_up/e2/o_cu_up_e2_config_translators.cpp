...
// =============================================================================
// FILE: apps/units/o_cu_up/e2/o_cu_up_e2_config_translators.cpp  (34 lines)
//
...
e2ap_configuration ocudu::generate_e2_config(const e2_config&              config,
                                             gnb_id_t                      gnb_id,
...
void ocudu::fill_o_cu_up_e2_worker_manager_config(worker_manager_config& config, const o_cu_up_e2_config& unit_cfg)
{
