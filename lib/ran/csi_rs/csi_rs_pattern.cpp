...
// =============================================================================
// FILE: lib/ran/csi_rs/csi_rs_pattern.cpp  (481 lines)
//
// LIBRARY: lib/ran
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  ocudu_assert(NOF_K_REF == k_ref.size(), "CSI-RS Mapping Row 1: 1 k_ref is needed");
  ocudu_assert(k_ref[0] <= 3, "CSI-RS Mapping Row 1: k_0 must be in the range 0..3 for row 1 mapping");
  ocudu_assert(config.freq_density == csi_rs_freq_density_type::three, "CSI-RS Mapping Row 1: invalid density");
  ocudu_assert(config.cdm == csi_rs_cdm_type::no_CDM, "CSI-RS Mapping Row 1: invalid CDM type");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  ocudu_assert(config.cdm == csi_rs_cdm_type::no_CDM, "CSI-RS Mapping Row 2: invalid CDM type");
                          ...
                          const csi_rs_pattern_configuration& config)
{
  ...
  ocudu_assert(config.cdm == csi_rs_cdm_type::fd_CDM2, "CSI-RS Mapping Row 3: invalid CDM type");
                           ...
                           const csi_rs_pattern_configuration& config)
{
  ...
  ocudu_assert(config.cdm == csi_rs_cdm_type::fd_CDM2, "CSI-RS Mapping Row 11: invalid CDM type");
                           ...
                           const csi_rs_pattern_configuration& config)
{
  ...
  ocudu_assert(config.cdm == csi_rs_cdm_type::cdm4_FD2_TD2, "CSI-RS Mapping Row 12: invalid CDM type");
...
csi_rs_pattern ocudu::get_csi_rs_pattern(const csi_rs_pattern_configuration& config)
{
  ...
  // Assert that the mapping table row is valid and currently supported.
  ocudu_assert(row <= 18 && row > 0, "Invalid mapping table row.");
  ocudu_assert(row <= 12, "Unsupported mapping table row");
