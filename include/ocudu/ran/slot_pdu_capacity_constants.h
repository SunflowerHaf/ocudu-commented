...
// =============================================================================
// FILE: include/ocudu/ran/slot_pdu_capacity_constants.h  (95 lines)
//
...
/// [Implementation-specific] Maximum Logical channels per TB.
constexpr size_t MAX_LC_PER_TB = 4;
...
/// [Implementation defined] Maximum number of downlink PDUs per slot.
constexpr size_t MAX_DL_PDUS_PER_SLOT = MAX_SSB_PER_SLOT + MAX_DL_PDCCH_PDUS_PER_SLOT + MAX_PDSCH_PDUS_PER_SLOT +
                                        MAX_CSI_RS_PDUS_PER_SLOT + MAX_PRS_PDUS_PER_SLOT;

/// [Implementation defined] Maximum number of uplink PDUs per slot.

/// [Implementation defined] Maximum number of uplink PDUs per slot.
constexpr size_t MAX_UL_PDUS_PER_SLOT =
    MAX_PRACH_OCCASIONS_PER_SLOT + MAX_PUCCH_PDUS_PER_SLOT + MAX_PUSCH_PDUS_PER_SLOT + MAX_SRS_PDUS_PER_SLOT;

/// [Implementation defined] Maximum number of UCI PDUS per UCI indication.

/// [Implementation defined] Maximum number of UCI PDUS per UCI indication.
constexpr size_t MAX_UCI_PDUS_PER_UCI_IND = MAX_PUCCH_PDUS_PER_SLOT;

/// [Implementation defined] Maximum number of SRS PDUS per SRS indication.

/// [Implementation defined] Maximum number of SRS PDUS per SRS indication.
constexpr size_t MAX_SRS_PDUS_PER_SRS_IND = MAX_SRS_PDUS_PER_SLOT;

/// [Implementation defined] Maximum number of HARQ VALUES per HARQ PDU.

/// [Implementation defined] Maximum number of HARQ VALUES per HARQ PDU.
constexpr size_t MAX_HARQ_VALUES_PER_HARQ_PDU = 8;

/// [Implementation defined] Maximum number of logical antenna ports (parallel streams) per beamforming PDU.

/// [Implementation defined] Maximum number of logical antenna ports (parallel streams) per beamforming PDU.
constexpr size_t MAX_LOGICAL_ANTENNA_PORTS_PER_BEAMFORMING_PDU = 4;
