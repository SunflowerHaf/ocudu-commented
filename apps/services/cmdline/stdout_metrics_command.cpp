...
// =============================================================================
// FILE: services/cmdline/stdout_metrics_command.cpp  (140 lines)
//
// Implements the 't' console command. Without arguments, lists available metric types. With a metric name argument (e.g. 't ue'), toggles that metric's STDOUT output on or off. Keeps a bitset of which subcommands are currently active; switching from one to another auto-disables the previous one.
// =============================================================================
