...
// =============================================================================
// FILE: helpers/metrics/json_generators/executors.cpp  (44 lines)
//
// Serialises executor (thread-pool) metrics to JSON: task counts, queue depths, worst-case dispatch latency.
// =============================================================================
