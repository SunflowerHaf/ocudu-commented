...
// =============================================================================
// FILE: include/ocudu/ofh/timing/slot_symbol_point.h  (152 lines)
//
...
public:
  ...
  {
    ocudu_assert(symbol_index_ < nof_symbols_, "Invalid symbol index");
  }
  ...
  {
    ocudu_assert(numerology < NOF_NUMEROLOGIES, "Invalid numerology idx={} passed", unsigned(numerology));
  }
