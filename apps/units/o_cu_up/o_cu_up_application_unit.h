...
// =============================================================================
// FILE: apps/units/o_cu_up/o_cu_up_application_unit.h  (36 lines)
//
// Purpose (plain English):
//   Abstract factory interface for the O-RAN CU-UP application unit. Same lifecycle hook pattern as o_cu_cp_application_unit but for the user-plane.
// =============================================================================
