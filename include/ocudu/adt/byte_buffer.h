...
// =============================================================================
// FILE: include/ocudu/adt/byte_buffer.h  (618 lines)
//
...
public:
  ...
  {
    ocudu_sanity_check(view.begin() - byte_buffer_view{buf}.begin() < (int)buf.length(),
  ...
  {
    ocudu_assert(offset + size <= length(), "Invalid view dimensions.");
