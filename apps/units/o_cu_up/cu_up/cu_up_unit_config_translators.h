...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/cu_up_unit_config_translators.h  (23 lines)
//
// Purpose (plain English):
//   Translates cu_up_unit_config to internal ocuup::cu_up_configuration and declares worker manager config fill function.
// =============================================================================
