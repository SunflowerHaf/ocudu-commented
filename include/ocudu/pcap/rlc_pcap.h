...
// =============================================================================
// FILE: include/ocudu/pcap/rlc_pcap.h  (153 lines)
//
...
namespace fmt {
template <>
struct formatter<ocudu::pcap_rlc_pdu_context> {
  ...
  auto format(const ocudu::pcap_rlc_pdu_context& pcap_context, FormatContext& ctx) const
  {
