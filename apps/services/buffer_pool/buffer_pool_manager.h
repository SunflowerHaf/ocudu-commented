...
// =============================================================================
// FILE: services/buffer_pool/buffer_pool_manager.h
//
// Purpose (plain English):
//   RAII manager for the byte-buffer segment pool: allocates the pool on construction and frees it on destruction. Also wires up pool-usage metrics.
// =============================================================================
