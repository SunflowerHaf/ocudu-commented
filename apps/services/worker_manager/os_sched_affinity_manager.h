...
// =============================================================================
// FILE: services/worker_manager/os_sched_affinity_manager.h
//
// Purpose (plain English):
//   CPU affinity and scheduling-policy types for thread pinning. Defines sched_affinity_mask_types (ru, main), sched_affinity_mask_policy (round-robin or mask), os_sched_affinity_config, and os_sched_affinity_manager which calculates bitmasks for each type.
// =============================================================================
