...
// =============================================================================
// FILE: du_high_ntn_config_translators.cpp  (53 lines)
//
// NTN-specific SRB and QoS timer augmentation: increases RLC retransmit, reordering, and status-prohibit timers to accommodate the satellite round-trip delay (hundreds of milliseconds).
// =============================================================================
