...
// =============================================================================
// FILE: include/ocudu/radio/radio_factory.h  (55 lines)
//
...
/// expected to be \c libocudu_radio_custom.so. The factory creation function within the dynamic library is expected to
