...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/network/sctp_cli11_schema.cpp
// Registers SCTP socket tuning options flat (no sub-command) so they appear
// alongside the parent interface's options. All values default to -1 unless
// explicitly set (meaning "use OS default").
// =============================================================================
