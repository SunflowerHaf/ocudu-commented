...
// =============================================================================
// FILE: apps/units/o_cu_cp/pcap_factory.h  (95 lines)
//
// Purpose (plain English):
//   Creates five PCAP writers for the CU-CP: NGAP (N2 core control), XNAP (inter-gNB Xn), F1AP (DU control), E1AP (CU-CP to CU-UP), E2AP (RIC). Each wired to a signal_observer for clean flush on SIGINT.
// =============================================================================
