...
// SPDX-FileCopyrightText: Copyright (C) 2021-2026 Software Radio Systems Limited
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// FILE: helpers/network/sctp_cli11_schema.h
// Registers SCTP socket options with CLI11. Added flat (no sub-command) so the
// options appear alongside the parent interface's options in the YAML.
#pragma once
