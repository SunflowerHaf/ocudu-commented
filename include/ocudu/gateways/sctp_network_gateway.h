...
// =============================================================================
// FILE: include/ocudu/gateways/sctp_network_gateway.h  (95 lines)
//
...
constexpr uint16_t XNAP_PPID  = 61; ///< XNAP PPID, see TS 38.472, section 7.
...
constexpr uint16_t XNAP_PORT = 38422; ///< XNAP port, see TS 38.422, section 7.
