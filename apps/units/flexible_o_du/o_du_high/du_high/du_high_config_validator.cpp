...
// =============================================================================
// FILE: du_high_config_validator.cpp  (1789 lines)
//
// ~1800 lines of pre-startup sanity checks against the parsed DU High config. Validates: cell bandwidth vs. PDCCH positions, PRACH frequency vs. PUCCH boundary, PDSCH/PUSCH MCS and layer limits, scheduler parameters, TDD pattern consistency, PUCCH resource grid fit, RLC timer constraints, QoS 5QI validity, PCAP type strings, and more. Returns false (with error message) on first failure.
// =============================================================================
