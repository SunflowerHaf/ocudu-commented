...
// =============================================================================
// FILE: lib/nru/nru_packing.cpp  (425 lines)
//
// LIBRARY: lib/nru
// NR-U (NR User Plane) protocol packing/unpacking for the F1-U interface (TS 38.425). Carries per-PDU information (PDCP SN, discardable, RLC-SN, DL/UL assistance data) between the DU and CU-UP inside GTP-U extension headers.
//
