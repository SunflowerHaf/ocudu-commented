...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/metrics/consumers/ngap_metrics_consumers.h  (29 lines)
//
// Purpose (plain English):
//   Log consumer for NGAP-level metrics (AMF connection status, UE registration counts, NGAP procedure success/fail).
// =============================================================================
