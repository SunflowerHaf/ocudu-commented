...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/f1u/f1u_config_yaml_writer.cpp
// Serialises F1-U socket config to YAML (bind/peer port, per-socket entries).
// Per-socket entries include bind_addr, optional S-NSSAI/5QI, and UDP params.
// =============================================================================
