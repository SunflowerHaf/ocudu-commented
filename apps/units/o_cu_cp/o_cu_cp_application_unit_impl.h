...
// =============================================================================
// FILE: apps/units/o_cu_cp/o_cu_cp_application_unit_impl.h  (50 lines)
//
// Purpose (plain English):
//   Concrete implementation of o_cu_cp_application_unit. Owns o_cu_cp_unit_config; implements all lifecycle hooks; orchestrates CLI11 registration, validation, logger setup, config dump, and worker manager setup.
// =============================================================================
