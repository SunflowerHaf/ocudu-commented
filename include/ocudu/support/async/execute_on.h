...
// =============================================================================
// FILE: include/ocudu/support/async/execute_on.h  (171 lines)
//
  ...
  struct task_executor_offloader {
    ...
    void await_suspend(coro_handle<> suspending_coro)
    {
      ...
      bool dispatched1 = dispatch_exec.execute([this]() mutable {
        ...
        ocudu_assert(dispatched2, "Failed to dispatch task");
      });
      ocudu_assert(dispatched1, "Failed to dispatch task");
    }
