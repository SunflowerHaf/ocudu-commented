...
// =============================================================================
// FILE: include/ocudu/rlc/rlc_tx_metrics.h  (318 lines)
//
...
// TODO print mode-specific metrics
template <>
struct formatter<ocudu::rlc_tx_metrics> {
  ...
  auto format(const ocudu::rlc_tx_metrics& m, FormatContext& ctx) const
  {
