...
// =============================================================================
// FILE: include/ocudu/adt/slotted_array.h  (378 lines)
//
...
public:
  ...
  {
    ocudu_assert(this->contains(idx), "Empty position in index {}", idx);
  ...
  void erase(iterator it) noexcept
  {
    ...
    (void)ret;
    ocudu_assert(ret, "Iterator must point to valid element");
  }
