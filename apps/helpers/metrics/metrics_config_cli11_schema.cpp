...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/metrics/metrics_config_cli11_schema.cpp
// Registers shared metrics output toggles (enable_json, enable_log, enable_verbose)
// under a [metrics] sub-command. Called by every unit that has metrics.
// =============================================================================
