...
// =============================================================================
// FILE: services/cmdline/cmdline_command_dispatcher.cpp  (197 lines)
//
// Watches /dev/stdin via io_broker for keypress input. Reads a full line, splits it into tokens, looks up the first token in the command map. If found, calls execute(); if not, prints 'h' help listing all registered commands and their descriptions.
// =============================================================================
