...
// =============================================================================
// FILE: include/ocudu/asn1/e1ap/common.h  (389 lines)
//
...
// PrivateIE-Container{E1AP-PRIVATE-IES : IEsSetParam} ::= SEQUENCE (SIZE (1..65535)) OF
// PrivateIE-Field{E1AP-PRIVATE-IES : IEsSetParam}
