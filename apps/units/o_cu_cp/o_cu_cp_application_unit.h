...
// =============================================================================
// FILE: apps/units/o_cu_cp/o_cu_cp_application_unit.h  (34 lines)
//
// Purpose (plain English):
//   Abstract factory interface for the O-RAN CU-CP application unit. Lifecycle hooks: on_parsing_configuration_registration() (CLI11 registration), on_configuration_validation(), on_loggers_registration(), create_o_cu_cp() (build the running CU-CP), dump_config(), fill_worker_manager_config().
// =============================================================================
