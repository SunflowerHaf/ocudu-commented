...
// =============================================================================
// FILE: lib/ocuduvec/unwrap.cpp  (54 lines)
//
...
void ocuduvec::unwrap_arguments(span<float> arguments, span<const cf_t> cplx_numbers)
{
  ocudu_assert(arguments.size() == cplx_numbers.size(),
