...
// =============================================================================
// FILE: services/application_tracer.h
//
// Purpose (plain English):
//   RAII wrapper for the binary event tracer. On enable_tracer() it opens the trace file; the destructor closes it. Used to profile executor task timing with external trace viewers.
// =============================================================================
