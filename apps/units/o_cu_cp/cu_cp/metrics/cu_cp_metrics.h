...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/metrics/cu_cp_metrics.h  (56 lines)
//
// Purpose (plain English):
//   Metrics framework wrappers for CU-CP metrics (UE count, handover success/fail, NGAP procedure counts). Parallel to du_metrics.h: defines properties, snapshot class, and dispatch callback.
// =============================================================================
