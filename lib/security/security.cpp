...
// =============================================================================
// FILE: lib/security/security.cpp  (261 lines)
//
...
void security_context::generate_as_keys()
{
  ...
  logger.info("K_gNB: {}", k);
  logger.info("RRC Integrity Key: {}", as_keys.k_rrc_int);
  logger.info("RRC Encryption Key: {}", as_keys.k_rrc_enc);
  logger.info("UP Integrity Key: {}", as_keys.k_up_int);
  logger.info("UP Encryption Key: {}", as_keys.k_up_enc);
}
