...
// =============================================================================
// FILE: include/ocudu/gtpu/gtpu_tunnel_nru_rx.h  (55 lines)
//
...
public:
  ...
  gtpu_tunnel_nru_rx_lower_layer_notifier(gtpu_tunnel_nru_rx_lower_layer_notifier&&)                 = delete;
  gtpu_tunnel_nru_rx_lower_layer_notifier& operator=(gtpu_tunnel_nru_rx_lower_layer_notifier&&)      = delete;
