...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/hal/hal_cli11_schema.cpp
// Registers the [hal] YAML section (DPDK EAL args) with CLI11.
// is_hal_section_present() lets callers avoid initialising DPDK unless the
// user actually wrote a [hal] block.
// =============================================================================
