...
// =============================================================================
// FILE: helpers/hal/hal_cli11_schema.h
//   Declares the CLI11 schema for the optional [hal] YAML block (DPDK EAL
//   args). Also provides is_hal_section_present() so callers can cheaply
//   check whether the user included a [hal] block before attempting any DPDK
//   initialisation.
// =============================================================================
#pragma once
