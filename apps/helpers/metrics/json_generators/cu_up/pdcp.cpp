...
// =============================================================================
// FILE: helpers/metrics/json_generators/cu_up/pdcp.cpp  (87 lines)
//
// Serialises PDCP TX/RX metrics to JSON: SDU/PDU counts, security operation counts and CPU usage.
// =============================================================================
