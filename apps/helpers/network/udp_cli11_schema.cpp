...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/network/udp_cli11_schema.cpp
// Registers UDP gateway options. ext_addr is at the top level of the parent
// section; the rest go under a [udp] sub-command to avoid cluttering the
// F1-U section's namespace.
// =============================================================================
...
void ocudu::configure_cli11_with_udp_config_schema(CLI::App& app, udp_appconfig& config)
{
  ...
  // ext_addr is top-level (beside bind_addr in F1-U socket config).
