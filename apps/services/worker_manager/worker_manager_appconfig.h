...
// =============================================================================
// FILE: services/worker_manager/worker_manager_appconfig.h
//
// Purpose (plain English):
//   User-facing (YAML) thread configuration: main pool size, queue size, back-off period, and CPU affinity masks for the main pool and the RU timing threads.
// =============================================================================
