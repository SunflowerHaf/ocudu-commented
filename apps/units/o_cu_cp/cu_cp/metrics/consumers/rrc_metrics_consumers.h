...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/metrics/consumers/rrc_metrics_consumers.h  (29 lines)
//
// Purpose (plain English):
//   Log consumer for RRC metrics (handover success/fail, paging counts, SIB updates, RRC connection setup/release).
// =============================================================================
