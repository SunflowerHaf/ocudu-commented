...
// =============================================================================
// FILE: apps/units/flexible_o_du/split_8/split_8_o_du_unit_config_yaml_writer.cpp  (18 lines)
//
...
void ocudu::fill_split_8_o_du_unit_config_in_yaml_schema(YAML::Node& node, const split_8_o_du_unit_config& config)
{
