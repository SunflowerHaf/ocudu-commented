...
// =============================================================================
// FILE: services/cmdline/cmdline_command_dispatcher.h
//
// Purpose (plain English):
//   Watches STDIN for operator keypresses. When input arrives, parses the first token as a command name and dispatches to the matching cmdline_command::execute(). Prints a help list if 'h' is pressed.
// =============================================================================
