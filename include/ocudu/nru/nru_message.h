...
// =============================================================================
// FILE: include/ocudu/nru/nru_message.h  (232 lines)
//
// INTERFACE HEADER — include/ocudu/nru
// NR-U interface headers: the NRU header packing/unpacking interface used by the F1-U transport to attach per-PDU metadata (PDCP SN, discard flag, DL/UL assistance data) to GTP-U extension headers.
//
