...
// =============================================================================
// FILE: helpers/metrics/json_generators/ru/ofh.cpp  (218 lines)
//
// Serialises Open Fronthaul (OFH) RU metrics to JSON per sector: DL/UL packet early/on-time/late counts, timing margin histograms.
// =============================================================================
