...
// =============================================================================
// FILE: include/ocudu/support/tracing/resource_usage.h  (83 lines)
//
...
/// Collect a new snapshot for the caller thread.
ocudu::expected<snapshot, int> now();
...
template <>
struct formatter<ocudu::resource_usage::diff> : public basic_parser {
  template <typename FormatContext>
  auto format(const ocudu::resource_usage::diff& diff, FormatContext& ctx) const
  {
