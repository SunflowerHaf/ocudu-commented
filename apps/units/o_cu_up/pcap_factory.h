...
// =============================================================================
// FILE: apps/units/o_cu_up/pcap_factory.h  (85 lines)
//
// Purpose (plain English):
//   Creates CU-UP PCAP writers: F1-U (GTP-U user plane to DU), E1AP (CU-CP to CU-UP control), E2AP (RIC), N3 (GTP-U to the UPF/5GC data plane). Wired to signal_observers.
// =============================================================================
