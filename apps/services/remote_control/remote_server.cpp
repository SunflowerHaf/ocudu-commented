...
// =============================================================================
// FILE: services/remote_control/remote_server.cpp  (323 lines)
//
// Implements the WebSocket HTTP server using uWebSockets. Listens on the configured address/port. Incoming messages are parsed as JSON: the 'command' field selects the remote_command to run; the 'params' field is the argument JSON. Responses are sent as JSON status/result objects. If metrics subscriptions are enabled, a separate WebSocket endpoint pushes JSON metric strings to subscribers.
// =============================================================================
