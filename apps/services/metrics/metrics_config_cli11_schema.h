...
// =============================================================================
// FILE: services/metrics/metrics_config_cli11_schema.h
//
// Purpose (plain English):
//   Declares configure_cli11_with_metrics_appconfig_schema() for registering the app-usage report period with CLI11.
// =============================================================================
