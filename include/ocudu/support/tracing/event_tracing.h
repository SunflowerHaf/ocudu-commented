...
// =============================================================================
// FILE: include/ocudu/support/tracing/event_tracing.h  (249 lines)
//
...
///                            this case, only the prior \c event_trigger_n number of events will be written in the
///                            file.
void open_trace_file(std::string_view trace_file_name = "/tmp/ocudu_trace.json",
...
struct trace_event {
  ...
  OCUDU_FORCE_INLINE constexpr trace_event(const char* name_, trace_point start_tp_) : name(name_), start_tp(start_tp_)
  {
  }
};
...
struct trace_thres_event {
  ...
  OCUDU_FORCE_INLINE constexpr trace_thres_event(const char* name_, trace_point start_tp_, trace_duration thres_) :
...
struct instant_trace_event {
  ...
  OCUDU_FORCE_INLINE constexpr instant_trace_event(const char*       name_,
                                                   cpu_scope         scope_,
...
struct rusage_trace_event {
  ...
  OCUDU_FORCE_INLINE constexpr rusage_trace_event(const char*              name_,
...
struct rusage_thres_trace_event {
  ...
  OCUDU_FORCE_INLINE constexpr rusage_thres_trace_event(const char*              name_,
...
{
public:
  explicit logger_event_tracer(ocudulog::log_channel* log_ch_) :
