...
// =============================================================================
// FILE: metrics/consumers/du_procedure_metrics_consumers.cpp
//   Formats a single log line reporting how many UEs were created in the last
//   metrics period and the average/maximum latency in microseconds.
// =============================================================================
...
{
  if (!report) {
    return; // No procedure data this period (no UE activity).
  }
