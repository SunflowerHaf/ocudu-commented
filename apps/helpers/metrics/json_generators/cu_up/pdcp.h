...
// =============================================================================
// FILE: helpers/metrics/json_generators/cu_up/pdcp.h
//
// Purpose (plain English):
//   Generates JSON from PDCP TX/RX metrics: SDU/PDU counts, bytes, reordering timeouts, ciphering/integrity CPU usage.
//
