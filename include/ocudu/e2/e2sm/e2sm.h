...
// =============================================================================
// FILE: include/ocudu/e2/e2sm/e2sm.h  (196 lines)
//
...
enum e2sm_service_model_t { KPM, RC, CCC, UNKNOWN_SM };
...
struct e2sm_ric_control_request {
  e2sm_service_model_t service_model                = e2sm_service_model_t::UNKNOWN_SM;
...
struct e2sm_ric_control_response {
  ...
  uint64_t             ric_call_process_id;
  std::variant<asn1::e2sm::e2sm_rc_ctrl_outcome_s, asn1::e2sm_ccc::ctrl_outcome_format_c> ric_ctrl_outcome;
...
public:
  ...
  /// \param[in] buf
  /// \return Returns the unpacked E2SM Action Definition.
  virtual e2sm_action_definition handle_packed_e2sm_action_definition(const ocudu::byte_buffer& buf) = 0;
  ...
  /// \param[in] buf
  /// \return Returns the E2SM Event Trigger Definition.
  virtual e2sm_event_trigger_definition handle_packed_event_trigger_definition(const ocudu::byte_buffer& buf) = 0;
...
public:
  ...
  /// \param[in] action is a RIC action to be setup (in binary form).
  /// \return Returns a unique_ptr to the e2sm report service.
  virtual std::unique_ptr<e2sm_report_service> get_e2sm_report_service(const ocudu::byte_buffer& action_definition) = 0;
