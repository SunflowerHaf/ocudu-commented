...
// =============================================================================
// FILE: apps/units/o_cu_cp/o_cu_cp_unit_impl.h  (39 lines)
//
// Purpose (plain English):
//   Runtime O-RAN CU-CP wrapper: owns the N2 (NGAP) connection clients, E2 metric connector manager, and the core ocucp::o_cu_cp object for the lifetime of the gNB run.
// =============================================================================
