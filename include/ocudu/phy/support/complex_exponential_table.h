...
// =============================================================================
// FILE: include/ocudu/phy/support/complex_exponential_table.h  (83 lines)
//
...
public:
  ...
  {
    ocudu_assert(index < table_size, "Index (i.e., {}) exceeds the table size (i.e., {})", index, table_size);
    return table[index];
  }
  ...
  {
    ocudu_assert(in.size() == out.size(), "The input and output sizes must be equal.");
