...
// =============================================================================
// FILE: include/ocudu/phy/upper/channel_processors/pucch/pucch_uci_message.h  (173 lines)
//
...
public:
  ...
  {
    ocudu_assert(config.nof_sr + config.nof_harq_ack + config.nof_csi_part1 + config.nof_csi_part2 <=
                     uci_constants::MAX_NOF_PAYLOAD_BITS,
