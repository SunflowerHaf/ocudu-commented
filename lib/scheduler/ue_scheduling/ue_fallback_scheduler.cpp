...
// =============================================================================
// FILE: lib/scheduler/ue_scheduling/ue_fallback_scheduler.cpp  (1586 lines)
//
                                              ...
                                              bool                                  is_retx)
{
  ...
  const vrb_interval       vrbs                = rb_helper::crb_to_vrb_ul_non_interleaved(
      ue_grant_crbs, u.get_pcell().cfg().search_space(pdcch.ctx.context.ss_id).bwp->ul.cfg().crbs.start());
