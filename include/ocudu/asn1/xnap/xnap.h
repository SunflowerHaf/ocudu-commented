...
// =============================================================================
// FILE: include/ocudu/asn1/xnap/xnap.h  (1096 lines)
//
...
// ProtocolIE-ContainerPair{XNAP-PROTOCOL-IES-PAIR : IEsSetParam} ::= SEQUENCE (SIZE (0..65535)) OF
// ProtocolIE-FieldPair{XNAP-PROTOCOL-IES-PAIR : IEsSetParam}
