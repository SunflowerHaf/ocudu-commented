...
// =============================================================================
// FILE: include/ocudu/adt/bit_buffer.h  (467 lines)
//
...
public:
  ...
  {
    ocudu_assert(nof_words() <= buffer.size(),
  ...
  {
    ocudu_assert(i_byte < nof_full_words(),
...
public:
  ...
  {
    ocudu_assert((size() - count) % bits_per_word == 0, "Only bit word boundaries are supported.");
