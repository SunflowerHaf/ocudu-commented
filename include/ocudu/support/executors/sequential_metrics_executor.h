...
// =============================================================================
// FILE: include/ocudu/support/executors/sequential_metrics_executor.h  (211 lines)
//
...
private:
  ...
  void handle_metrics(bool                                           is_exec,
                      ...
                      time_point                                     start_tp,
                      const expected<resource_usage::snapshot, int>& start_rusg) noexcept OCUDU_RTSAN_NONBLOCKING
  {
