...
// =============================================================================
// FILE: services/remote_control/remote_command.h
//
// Purpose (plain English):
//   Abstract base class for HTTP remote commands. get_name() is the URL path component; execute(json) parses the JSON body and returns success or an error string.
// =============================================================================
