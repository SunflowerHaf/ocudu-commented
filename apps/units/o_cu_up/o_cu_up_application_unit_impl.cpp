...
// =============================================================================
// FILE: apps/units/o_cu_up/o_cu_up_application_unit_impl.cpp  (72 lines)
//
...
std::unique_ptr<o_cu_up_application_unit> ocudu::create_o_cu_up_application_unit(std::string_view app_name)
{
