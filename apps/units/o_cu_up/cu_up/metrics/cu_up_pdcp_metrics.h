...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/metrics/cu_up_pdcp_metrics.h  (55 lines)
//
// Purpose (plain English):
//   Metrics framework wrappers for PDCP metrics: ciphered/deciphered PDU counts, integrity failures, t-Reordering timeouts. Defines properties, snapshot class, dispatch callback.
// =============================================================================
