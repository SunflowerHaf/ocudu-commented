...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/cu_cp_unit_pcap_config.h  (31 lines)
//
// Purpose (plain English):
//   PCAP enable/filename config for CU-CP control-plane protocols: NGAP (to 5GC AMF), XNAP (to peer gNBs), E1AP (to CU-UP), F1AP (to DU).
// =============================================================================
