...
// =============================================================================
// FILE: lib/security/ciphering_engine_nea1.cpp  (30 lines)
//
...
security_status ciphering_engine_nea1::apply_ciphering(byte_buffer& buf, size_t offset, uint32_t count)
{
