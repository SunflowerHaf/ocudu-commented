...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/e2/e2_config_yaml_writer.cpp
// Serialises the shared E2 config (RIC addresses, port, bind addresses, SCTP
// params, E2SM flags) to YAML. Called by each unit's own YAML writer.
// =============================================================================
