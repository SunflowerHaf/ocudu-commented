...
// =============================================================================
// FILE: include/ocudu/ran/logical_channel/phr_report.h  (81 lines)
//
...
struct phr_report {
  ...
  {
    ocudu_assert(not ph_reports.empty(), "Invalid access to SE-PHR report. Cause: No PHR report set.");
  ...
  {
    ocudu_assert(ph_reports.size() > 0, "PHR report not set.");
