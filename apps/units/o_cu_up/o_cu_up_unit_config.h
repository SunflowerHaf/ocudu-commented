...
// =============================================================================
// FILE: apps/units/o_cu_up/o_cu_up_unit_config.h  (18 lines)
//
// Purpose (plain English):
//   Top-level config for the O-RAN CU-UP unit: aggregates cu_up_unit_config (GTP-U, PDCP, F1-U sockets, ROHC, security, QoS, metrics, PCAPs, logging) plus o_cu_up_e2_config.
// =============================================================================
