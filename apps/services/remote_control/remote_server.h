...
// =============================================================================
// FILE: services/remote_control/remote_server.h
//
// Purpose (plain English):
//   WebSocket HTTP server that receives remote_command requests from operators or the RIC. add_commands() registers which operations are available; the server routes incoming JSON messages to the right command's execute(). Also exposes a metrics_gateway for pushing JSON metrics to subscribers.
// =============================================================================
