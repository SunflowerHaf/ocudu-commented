...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/cu_cp_unit_config_helpers.h  (66 lines)
//
// Purpose (plain English):
//   Parsing utilities for the CU-CP CLI11 schema: is_number(), is_valid_timestamp() (ISO 8601 regex), parse_timestamp_ms() (Unix-ms int or ISO 8601 to system_clock::time_point). Used for NTN and handover timing fields.
// =============================================================================
