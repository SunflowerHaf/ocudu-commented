...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/cu_up_logger_registrator.h  (50 lines)
//
// Purpose (plain English):
//   Registers CU-UP log channels: CU-UP, PDCP, RRC (PDCP security context reuse), GTPU, E1AP, DU-F1-U.
// =============================================================================
