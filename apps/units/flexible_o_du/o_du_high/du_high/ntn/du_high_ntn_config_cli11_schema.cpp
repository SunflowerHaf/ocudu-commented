...
// =============================================================================
// FILE: du_high_ntn_config_cli11_schema.cpp  (607 lines)
//
// Registers NTN config CLI11 options: K-offset, ephemeris type/data (ECEF vs orbital), UE location threshold, t_service (satellite coverage end time), k_mac, validity duration, feeder-link, gateway location, TA reporting, and advanced Release 18 fields. Three entry points: base config, advanced config, per-cell override.
// =============================================================================
