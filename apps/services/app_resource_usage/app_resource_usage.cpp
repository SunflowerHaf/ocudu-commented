...
// =============================================================================
// FILE: services/app_resource_usage/app_resource_usage.cpp  (130 lines)
//
// Periodically reads /proc/self/status (Linux) or getrusage() to collect RSS memory, virtual memory, user CPU time, system CPU time, and voluntary/involuntary context-switch counts. Emits these as resource_usage_metrics once per reporting period.
// =============================================================================
