...
// =============================================================================
// FILE: include/ocudu/ran/resource_allocation/vrb_to_prb.h  (307 lines)
//
...
inline configuration create_interleaved_other(unsigned N_bwp_i_start, unsigned N_bwp_i_size, mapping_type L_i)
{
  ...
  ocudu_assert(L == 2 || L == 4, "Invalid bundle size {}. Valid values are 2 or 4.", L);
...
public:
  ...
  {
    ocudu_assert(not config.is_interleaved(), "Invalid configuration for non-interleaved mapping.");
  }
