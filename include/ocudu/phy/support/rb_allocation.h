...
// =============================================================================
// FILE: include/ocudu/phy/support/rb_allocation.h  (177 lines)
//
...
/// \brief Custom formatter for pusch_processor::rb_allocation.
template <>
struct formatter<ocudu::rb_allocation> {
  ...
  auto format(const ocudu::rb_allocation& rb_alloc, FormatContext& ctx) const
  {
