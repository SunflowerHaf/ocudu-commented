...
// =============================================================================
// FILE: helpers/metrics/json_generators/executors.h
//
// Purpose (plain English):
//   Generates JSON from thread-pool executor metrics: task queue depths, dispatch latencies, worker utilisation.
//
