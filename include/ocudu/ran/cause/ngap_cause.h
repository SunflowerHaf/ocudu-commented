...
// =============================================================================
// FILE: include/ocudu/ran/cause/ngap_cause.h  (400 lines)
//
...
template <>
struct formatter<ocudu::ngap_cause_radio_network_t> {
  ...
  auto format(const ocudu::ngap_cause_radio_network_t& cause, FormatContext& ctx) const
  {
    if (cause == ocudu::ngap_cause_radio_network_t::unspecified) {
      return format_to(ctx.out(), "unspecified");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::txnrelocoverall_expiry) {
      return format_to(ctx.out(), "txnrelocoverall_expiry");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::successful_ho) {
      return format_to(ctx.out(), "successful_ho");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::release_due_to_ngran_generated_reason) {
      return format_to(ctx.out(), "release_due_to_ngran_generated_reason");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::release_due_to_5gc_generated_reason) {
      return format_to(ctx.out(), "release_due_to_5gc_generated_reason");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ho_cancelled) {
      return format_to(ctx.out(), "ho_cancelled");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::partial_ho) {
      return format_to(ctx.out(), "partial_ho");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ho_fail_in_target_5_gc_ngran_node_or_target_sys) {
      return format_to(ctx.out(), "ho_fail_in_target_5_gc_ngran_node_or_target_sys");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ho_target_not_allowed) {
      return format_to(ctx.out(), "ho_target_not_allowed");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::tngrelocoverall_expiry) {
      return format_to(ctx.out(), "tngrelocoverall_expiry");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::tngrelocprep_expiry) {
      return format_to(ctx.out(), "tngrelocprep_expiry");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::cell_not_available) {
      return format_to(ctx.out(), "cell_not_available");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::unknown_target_id) {
      return format_to(ctx.out(), "unknown_target_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::no_radio_res_available_in_target_cell) {
      return format_to(ctx.out(), "no_radio_res_available_in_target_cell");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::unknown_local_ue_ngap_id) {
      return format_to(ctx.out(), "unknown_local_ue_ngap_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::inconsistent_remote_ue_ngap_id) {
      return format_to(ctx.out(), "inconsistent_remote_ue_ngap_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ho_desirable_for_radio_reason) {
      return format_to(ctx.out(), "ho_desirable_for_radio_reason");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::time_crit_ho) {
      return format_to(ctx.out(), "time_crit_ho");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::res_optim_ho) {
      return format_to(ctx.out(), "res_optim_ho");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::reduce_load_in_serving_cell) {
      return format_to(ctx.out(), "reduce_load_in_serving_cell");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::user_inactivity) {
      return format_to(ctx.out(), "user_inactivity");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::radio_conn_with_ue_lost) {
      return format_to(ctx.out(), "radio_conn_with_ue_lost");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::radio_res_not_available) {
      return format_to(ctx.out(), "radio_res_not_available");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::invalid_qos_combination) {
      return format_to(ctx.out(), "invalid_qos_combination");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::fail_in_radio_interface_proc) {
      return format_to(ctx.out(), "fail_in_radio_interface_proc");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::interaction_with_other_proc) {
      return format_to(ctx.out(), "interaction_with_other_proc");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::unknown_pdu_session_id) {
      return format_to(ctx.out(), "unknown_pdu_session_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::unkown_qos_flow_id) {
      return format_to(ctx.out(), "unkown_qos_flow_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::multiple_pdu_session_id_instances) {
      return format_to(ctx.out(), "multiple_pdu_session_id_instances");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::multiple_qos_flow_id_instances) {
      return format_to(ctx.out(), "multiple_qos_flow_id_instances");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::encryption_and_or_integrity_protection_algorithms_not_supported) {
      return format_to(ctx.out(), "encryption_and_or_integrity_protection_algorithms_not_supported");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ng_intra_sys_ho_triggered) {
      return format_to(ctx.out(), "ng_intra_sys_ho_triggered");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ng_inter_sys_ho_triggered) {
      return format_to(ctx.out(), "ng_inter_sys_ho_triggered");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::xn_ho_triggered) {
      return format_to(ctx.out(), "xn_ho_triggered");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::not_supported_5qi_value) {
      return format_to(ctx.out(), "not_supported_5qi_value");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ue_context_transfer) {
      return format_to(ctx.out(), "ue_context_transfer");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ims_voice_eps_fallback_or_rat_fallback_triggered) {
      return format_to(ctx.out(), "ims_voice_eps_fallback_or_rat_fallback_triggered");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::up_integrity_protection_not_possible) {
      return format_to(ctx.out(), "up_integrity_protection_not_possible");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::up_confidentiality_protection_not_possible) {
      return format_to(ctx.out(), "up_confidentiality_protection_not_possible");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::slice_not_supported) {
      return format_to(ctx.out(), "slice_not_supported");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ue_in_rrc_inactive_state_not_reachable) {
      return format_to(ctx.out(), "ue_in_rrc_inactive_state_not_reachable");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::redirection) {
      return format_to(ctx.out(), "redirection");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::res_not_available_for_the_slice) {
      return format_to(ctx.out(), "res_not_available_for_the_slice");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::ue_max_integrity_protected_data_rate_reason) {
      return format_to(ctx.out(), "ue_max_integrity_protected_data_rate_reason");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::release_due_to_cn_detected_mob) {
      return format_to(ctx.out(), "release_due_to_cn_detected_mob");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::n26_interface_not_available) {
      return format_to(ctx.out(), "n26_interface_not_available");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::release_due_to_pre_emption) {
      return format_to(ctx.out(), "release_due_to_pre_emption");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::multiple_location_report_ref_id_instances) {
      return format_to(ctx.out(), "multiple_location_report_ref_id_instances");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::rsn_not_available_for_the_up) {
      return format_to(ctx.out(), "rsn_not_available_for_the_up");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::npn_access_denied) {
      return format_to(ctx.out(), "npn_access_denied");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::cag_only_access_denied) {
      return format_to(ctx.out(), "cag_only_access_denied");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::insufficient_ue_cap) {
      return format_to(ctx.out(), "insufficient_ue_cap");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::redcap_ue_not_supported) {
      return format_to(ctx.out(), "redcap_ue_not_supported");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::unknown_mbs_session_id) {
      return format_to(ctx.out(), "unknown_mbs_session_id");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::indicated_mbs_session_area_info_not_served_by_the_gnb) {
      return format_to(ctx.out(), "indicated_mbs_session_area_info_not_served_by_the_gnb");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::inconsistent_slice_info_for_the_session) {
      return format_to(ctx.out(), "inconsistent_slice_info_for_the_session");
    }
    if (cause == ocudu::ngap_cause_radio_network_t::misaligned_assoc_for_multicast_unicast) {
...
template <>
struct formatter<ocudu::ngap_cause_transport_t> {
  template <typename ParseContext>
  auto parse(ParseContext& ctx)
  {
    return ctx.begin();
  ...
  template <typename FormatContext>
  auto format(const ocudu::ngap_cause_transport_t& cause, FormatContext& ctx) const
  {
    if (cause == ocudu::ngap_cause_transport_t::transport_res_unavailable) {
      return format_to(ctx.out(), "transport_res_unavailable");
    }
    if (cause == ocudu::ngap_cause_transport_t::unspecified) {
      return format_to(ctx.out(), "unspecified");
    }
...
template <>
struct formatter<ocudu::cause_nas_t> {
  template <typename ParseContext>
  auto parse(ParseContext& ctx)
  {
    return ctx.begin();
  ...
  template <typename FormatContext>
  auto format(const ocudu::cause_nas_t& cause, FormatContext& ctx) const
  {
    if (cause == ocudu::cause_nas_t::normal_release) {
      return format_to(ctx.out(), "normal_release");
    }
    if (cause == ocudu::cause_nas_t::authentication_fail) {
      return format_to(ctx.out(), "authentication_fail");
    }
    if (cause == ocudu::cause_nas_t::deregister) {
      return format_to(ctx.out(), "deregister");
    }
    if (cause == ocudu::cause_nas_t::unspecified) {
      return format_to(ctx.out(), "unspecified");
    }
...
template <>
struct formatter<ocudu::ngap_cause_misc_t> {
  template <typename ParseContext>
  auto parse(ParseContext& ctx)
  {
    return ctx.begin();
  ...
  template <typename FormatContext>
  auto format(const ocudu::ngap_cause_misc_t& cause, FormatContext& ctx) const
  {
    if (cause == ocudu::ngap_cause_misc_t::ctrl_processing_overload) {
      return format_to(ctx.out(), "ctrl_processing_overload");
    }
    if (cause == ocudu::ngap_cause_misc_t::not_enough_user_plane_processing_res) {
      return format_to(ctx.out(), "not_enough_user_plane_processing_res");
    }
    if (cause == ocudu::ngap_cause_misc_t::hardware_fail) {
      return format_to(ctx.out(), "hardware_fail");
    }
    if (cause == ocudu::ngap_cause_misc_t::om_intervention) {
      return format_to(ctx.out(), "om_intervention");
    }
    if (cause == ocudu::ngap_cause_misc_t::unknown_plmn_or_sn_pn) {
      return format_to(ctx.out(), "unknown_plmn_or_sn_pn");
    }
    if (cause == ocudu::ngap_cause_misc_t::unspecified) {
      return format_to(ctx.out(), "unspecified");
    }
