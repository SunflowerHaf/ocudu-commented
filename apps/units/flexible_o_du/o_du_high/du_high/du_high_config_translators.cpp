...
// =============================================================================
// FILE: du_high_config_translators.cpp  (1339 lines)
//
// Translates the user-facing DU High unit config into internal representations. Key functions: generate_du_cell_config() (per-cell PDSCH/PUSCH/PUCCH/PRACH/scheduler params), generate_du_high_config() (the full odu::du_high_configuration), fill_du_high_worker_manager_config() (executor requirements to the thread-pool manager). Also applies NTN-specific SRB/QoS timer overrides when a cell has an [ntn] block.
// =============================================================================
