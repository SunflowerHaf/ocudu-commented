...
// =============================================================================
// FILE: lib/sdap/sdap_session_logger.h  (92 lines)
//
// LIBRARY: lib/sdap
// Service Data Adaptation Protocol (SDAP, TS 37.324): maps QoS flows from the 5GC (identified by QFI) to radio bearers (DRBs). Sits above PDCP in the CU-UP. Adds a one-byte SDAP header to every downlink PDU.
//
