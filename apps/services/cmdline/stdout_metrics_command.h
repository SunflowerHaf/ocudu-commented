...
// =============================================================================
// FILE: services/cmdline/stdout_metrics_command.h
//
// Purpose (plain English):
//   The 't' console command that toggles live per-UE metrics on/off. toggle_stdout_metrics_app_command holds a list of metrics_subcommand objects (one per metric type, e.g. 'ue' for DU scheduler); pressing 't ue' switches the UE table on or off.
// =============================================================================
