...
// =============================================================================
// FILE: include/ocudu/adt/detail/byte_buffer_segment_list.h  (352 lines)
//
...
public:
  ...
  byte_buffer_segment_byte_iterator_impl& operator+=(unsigned n)
  {
    ...
    ocudu_assert(current_segment != nullptr or offset == 0, "Out-of-bounds Access");
    return *this;
  }
...
public:
    ...
    current_segment(seg), offset(offset_), rem_bytes(size_)
  {
    ...
    ocudu_assert(current_segment != nullptr or (offset == 0 and rem_bytes == 0),
                 "Positive offset or length for empty segment");
    ocudu_assert(current_segment == nullptr or offset <= current_segment->length(), "Invalid offset");
  }
  ...
  {
    ocudu_assert(current_segment != nullptr, "operator++ called after end()");
