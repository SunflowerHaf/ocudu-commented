...
// =============================================================================
// FILE: include/ocudu/support/executors/strand_executor.h  (518 lines)
//
...
public:
  ...
  [[nodiscard]] uint32_t on_task_completion(uint32_t tasks_completed)
  {
    ...
    ocudu_sanity_check((cur_value & locked_mask) != 0, "Invalid state");
    ...
    ocudu_sanity_check((cur_value & count_mask) > 0, "Invalid state");
