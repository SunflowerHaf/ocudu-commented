...
// =============================================================================
// FILE: lib/ocudulog/ocudulog_instance.h  (118 lines)
//
...
#include "ocudu/ocudulog/sink_repository.h"
...
/// Singleton of the framework containing all the required classes.
class ocudulog_instance : public sink_repository
{
  ocudulog_instance()
  {
...
public:
  ocudulog_instance(const ocudulog_instance& other)            = delete;
  ocudulog_instance& operator=(const ocudulog_instance& other) = delete;

  /// Access function to the singleton instance.

  /// Access function to the singleton instance.
  static ocudulog_instance& get()
  {
    static ocudulog_instance instance;
    return instance;
  }
