...
// =============================================================================
// FILE: apps/units/flexible_o_du/split_8/split_8_o_du_application_unit_impl.h  (50 lines)
//
...
{
public:
  explicit split_8_o_du_application_unit_impl(std::string_view app_name);
