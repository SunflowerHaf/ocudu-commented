...
// =============================================================================
// FILE: include/ocudu/ran/pucch/pucch_context_formatter.h  (33 lines)
//
...
/// \brief Custom formatter for \c pucch_context.
template <>
struct formatter<ocudu::pucch_context> {
public:
  ...
  auto format(const ocudu::pucch_context& context, FormatContext& ctx) const
  {
