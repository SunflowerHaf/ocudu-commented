...
// =============================================================================
// FILE: helpers/network/sctp_config_translators.h
//
// Purpose (plain English):
//   Provides fill_sctp_network_gateway_config_socket_params() — an inline
//   function that copies sctp_appconfig fields into the lower-level
//   sctp_network_gateway_config struct used by the SCTP transport library.
//
//   The convention "-1 means use system default" is implemented here: each
//   field is only copied if its value is >= 0, so if the user leaves a field
//   at -1, the corresponding std::optional in the gateway config stays empty
//   and the OS uses its own default.
// =============================================================================
#pragma once
