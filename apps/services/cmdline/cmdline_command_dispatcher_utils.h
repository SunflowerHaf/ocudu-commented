...
// =============================================================================
// FILE: services/cmdline/cmdline_command_dispatcher_utils.h
//
// Purpose (plain English):
//   Integer and float parsing utilities for console command arguments. Uses std::from_chars (C++17 fast, no-locale integer parser) with a clear error return type.
// =============================================================================
