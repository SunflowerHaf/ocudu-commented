...
// =============================================================================
// FILE: include/ocudu/rlc/rlc_rx_metrics.h  (168 lines)
//
...
// TODO print mode-specific metrics
template <>
struct formatter<ocudu::rlc_rx_metrics> {
  ...
  auto format(const ocudu::rlc_rx_metrics& m, FormatContext& ctx) const
  {
