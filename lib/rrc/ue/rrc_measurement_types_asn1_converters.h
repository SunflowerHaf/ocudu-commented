...
// =============================================================================
// FILE: lib/rrc/ue/rrc_measurement_types_asn1_converters.h  (167 lines)
//
// LIBRARY: lib/rrc
...
/// \brief Converts type \c rrc_ssb_cfg_mob to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_csi_rs_res_cfg_mob_setup_release to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_thres_nr to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_q_offset_range_list to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_meas_obj_nr to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_srs_periodicity_and_offset to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_srs_res to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_meas_obj_to_add_mod to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_meas_report_quant to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_nr_rs_type to an RRC NR ASN.1 type.
...
/// \brief Converts type \c uint32_t to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_periodical_report_cfg to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_meas_trigger_quant to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_event_trigger_cfg to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_cond_trigger_cfg to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_report_cfg_nr to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_report_cfg_to_add_mod to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_meas_id_to_add_mod to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_filt_cfg to an RRC NR ASN.1 type.
...
/// \brief Converts type \c rrc_quant_cfg_rs to an RRC NR ASN.1 type.
...
/// \brief Converts ASN.1 type \c asn1::rrc_nr::meas_quant_results_s to common type.
...
/// \brief Converts ASN.1 type \c asn1::rrc_nr::meas_result_nr_s to common type.
...
/// \brief Converts ASN.1 type \c asn1::rrc_nr::meas_results_s to common type.
