...
// =============================================================================
// FILE: include/ocudu/phy/lower/sampling_rate.h  (171 lines)
//
...
public:
  ...
  {
    ocudu_assert(is_valid(scs_Hz), "Subcarrier spacing must be valid.");
...
private:
  ...
  {
    ocudu_assert(is_valid(15000), "The sampling rate must be multiple of 15kHz.");
  }
...
/// FMT formatter of sampling_rate type.
template <>
struct formatter<ocudu::sampling_rate> {
  ...
  auto format(ocudu::sampling_rate srate, FormatContext& ctx) const
  {
