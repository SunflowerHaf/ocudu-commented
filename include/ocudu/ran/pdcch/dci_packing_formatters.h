...
// =============================================================================
// FILE: include/ocudu/ran/pdcch/dci_packing_formatters.h  (153 lines)
//
...
/// \brief Custom formatter for \c dci_0_0_size.
template <>
struct formatter<ocudu::dci_0_0_size> {
  ...
  /// Default constructor.
  formatter() { helper = ocudu::delimited_formatter("\n"); }
  ...
  auto format(const ocudu::dci_0_0_size& dci_size, FormatContext& ctx) const
  {
...
/// \brief Custom formatter for \c dci_1_0_size.
template <>
struct formatter<ocudu::dci_1_0_size> {
  /// Helper used to parse formatting options and format fields.
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::dci_1_0_size& dci_size, FormatContext& ctx) const
  {
    helper.format_always(ctx, "Total:              {}", dci_size.total);
    helper.format_always(ctx, "Frequency resource: {}", dci_size.frequency_resource);
...
/// \brief Custom formatter for \c dci_0_1_size.
template <>
struct formatter<ocudu::dci_0_1_size> {
  /// Helper used to parse formatting options and format fields.
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::dci_0_1_size& dci_size, FormatContext& ctx) const
  {
    helper.format_always(ctx, "Total:                 {}", dci_size.total);
...
/// \brief Custom formatter for \c dci_1_1_size.
template <>
struct formatter<ocudu::dci_1_1_size> {
  /// Helper used to parse formatting options and format fields.
  /// Helper used to parse formatting options and format fields.
  ocudu::delimited_formatter helper;
  ...
  template <typename FormatContext>
  auto format(const ocudu::dci_1_1_size& dci_size, FormatContext& ctx) const
  {
    helper.format_always(ctx, "Total:                   {}", dci_size.total);
    helper.format_always(ctx, "Carrier indicator:       {}", dci_size.carrier_indicator);
    helper.format_always(ctx, "BWP indicator:           {}", dci_size.bwp_indicator);
