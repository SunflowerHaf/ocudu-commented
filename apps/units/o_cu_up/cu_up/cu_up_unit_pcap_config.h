...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/cu_up_unit_pcap_config.h  (32 lines)
//
// Purpose (plain English):
//   PCAP enable/filename for CU-UP protocols: F1-U (GTP-U user plane), E1AP (CU-CP<->CU-UP), N3 (GTP-U to UPF), E2AP (RIC).
// =============================================================================
