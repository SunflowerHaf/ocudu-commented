...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/cu_cp_unit_config.h  (422 lines)
//
// Purpose (plain English):
//   Master CU-CP config struct (422 lines). Contains: AMF connection (NGAP SCTP, tracking areas, PLMN/slice lists), measurement/handover configs (A1-A6 events, D1/D2 distance-based, T1 time-based conditional triggers), cell-neighbour relationships, RRC timer values, PDCP/security settings, QoS mappings, CU-CP identity, metrics config, and test-mode UE settings.
// =============================================================================
