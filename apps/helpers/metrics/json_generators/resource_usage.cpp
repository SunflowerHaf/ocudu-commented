...
// =============================================================================
// FILE: helpers/metrics/json_generators/resource_usage.cpp  (43 lines)
//
// Serialises OS process resource usage to JSON: CPU time (user/sys), RSS/VMS memory, context switches.
// =============================================================================
