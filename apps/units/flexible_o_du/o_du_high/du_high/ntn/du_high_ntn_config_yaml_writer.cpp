...
// =============================================================================
// FILE: du_high_ntn_config_yaml_writer.cpp  (197 lines)
//
// Serialises the per-cell NTN config (K-offset, ephemeris, epoch time, ta_info, etc.) into a YAML node for the print-effective-config feature.
// =============================================================================
