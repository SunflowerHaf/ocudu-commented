...
// =============================================================================
// FILE: include/ocudu/pdcp/pdcp_entity.h  (65 lines)
//
...
namespace fmt {
template <>
struct formatter<ocudu::pdcp_metrics_container> {
  ...
  auto format(const ocudu::pdcp_metrics_container& m, FormatContext& ctx) const
  {
