...
// =============================================================================
// FILE: apps/units/o_cu_cp/cu_cp/metrics/cu_cp_metrics_producer.h  (29 lines)
//
// Purpose (plain English):
//   Receives cu_cp_metrics_report from the CU-CP core, wraps it in a snapshot, and pushes to the fan-out pipeline.
// =============================================================================
