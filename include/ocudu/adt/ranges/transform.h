...
// =============================================================================
// FILE: include/ocudu/adt/ranges/transform.h  (106 lines)
//
...
class transform_view
{
  ...
  public:
    ...
    {
      ocudu_sanity_check(it != parent->r.end(), "Iterator incremented past end() point");
      ++it;
      return *this;
    }
    ...
    {
      ocudu_sanity_check(other.parent == parent, "Invalid subtraction of iterators of different ranges");
      return it - other.it;
    }
