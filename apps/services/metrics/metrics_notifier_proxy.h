...
// =============================================================================
// FILE: services/metrics/metrics_notifier_proxy.h
//
// Purpose (plain English):
//   A null-proxy implementation of metrics_notifier that can be connected at runtime. Allows building a metrics pipeline before the actual notifier exists, then wiring it up later.
// =============================================================================
