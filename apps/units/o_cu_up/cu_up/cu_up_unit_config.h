...
// =============================================================================
// FILE: apps/units/o_cu_up/cu_up/cu_up_unit_config.h  (127 lines)
//
// Purpose (plain English):
//   CU-UP config struct (127 lines): GTP-U bind address, PDCP (RX window size, t-Reordering timer, ROHC max CID), QoS/5QI-to-DRB mappings, F1-U socket list, security algorithms (ciphering and integrity), maximum UE count, metrics, logging, PCAPs.
// =============================================================================
