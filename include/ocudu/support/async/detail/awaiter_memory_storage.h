...
// =============================================================================
// FILE: include/ocudu/support/async/detail/awaiter_memory_storage.h  (124 lines)
//
...
struct small_memory_buffer_t {
  ~small_memory_buffer_t() { ocudu_sanity_check(empty(), "Removing small memory buffer without deleting object"); }
  ...
  void emplace(Args&&... args)
  {
    ...
    ocudu_sanity_check(empty(), "Overwrites are not supported");
...
struct awaiter_memory_storage_t {
  ...
  ~awaiter_memory_storage_t() { ocudu_assert(empty(), "Emptying non-destroyed object"); }
