...
// =============================================================================
// FILE: helpers/metrics/json_generators/o_du_low.cpp  (313 lines)
//
// Serialises O-DU Low (upper PHY) metrics to JSON: PDSCH/PUSCH processing latencies, decode error counts, TB success rates per cell.
// =============================================================================
