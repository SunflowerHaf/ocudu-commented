...
// SPDX-License-Identifier: BSD-3-Clause-Open-MPI
// =============================================================================
// FILE: helpers/metrics/metrics_helpers.cpp
//
// Purpose (plain English):
//   Implements the shared metrics log channel infrastructure.
//   Two named log channels:
//     "METRICS"      — used by rlc_metrics_consumer_log, du_metrics_consumer_log, etc.
//     "JSON_channel" — used if JSON debug logging of metrics is needed.
//   initialize_metrics_log_channels() creates and enables the METRICS channel
//   only if log metrics are enabled; if the flag is off, the channel stays
//   disabled and consumer writes are discarded cheaply.
// =============================================================================
